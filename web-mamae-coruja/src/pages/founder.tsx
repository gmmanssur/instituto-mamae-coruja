                ...
                <div className="grid lg:grid-cols-12 gap-8 md:gap-12 items-center">
                    <div className="lg:col-span-5 lg:col-start-1 relative px-4 sm:px-0">
                        ...
                        >
                            ...
                            <p className="text-gray-600 italic font-medium text-[10px] md:text-xs leading-relaxed">
                    ...
                    <div className="lg:col-span-7 space-y-6 md:space-y-8">
                        ...
                        <div className="bg-white p-4 md:p-6 rounded-2xl shadow-sm border border-yellow-100 text-center flex flex-col justify-center min-h-[100px]">
